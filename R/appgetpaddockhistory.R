...
appgetpaddockhistory <- function(cattle_id = NULL, RFID = NULL, MTag = NULL, property = NULL, Paddock = NULL, currentPaddock = NULL, timezone = NULL, start = NULL, end = NULL, fields = NULL, username = NULL, password = NULL){
