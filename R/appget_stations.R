...
appget_stations <- function(stationname = NULL, report = NULL, active = NULL, fields = NULL, username = NULL, password = NULL){
...
search <-paste0("{", stationname, report, active,"}")
